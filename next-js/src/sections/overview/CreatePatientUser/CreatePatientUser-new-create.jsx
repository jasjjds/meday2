  ...
  const renderForm = () => (
    <Box sx={{ mt: 2 }}>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={6}>
          <Field.Text name="PatientId" label="Mã bệnh nhân" slotProps={{ inputLabel: { shrink: true } }} fullWidth />
        </Grid>
        <Grid item xs={12} sm={6}>
          <Field.Text name="PatientUserName" label="Tên bệnh nhân" slotProps={{ inputLabel: { shrink: true } }} fullWidth />
        </Grid>
        <Grid item xs={12} sm={6}>
        ...
        <Grid item xs={12} sm={6}>
          <Field.Text name="Date" label="Ngày sinh" slotProps={{ inputLabel: { shrink: true } }} fullWidth />
        </Grid>
        <Grid item xs={12} sm={6}>
          <Field.Text name="Sex" label="Giới tính" slotProps={{ inputLabel: { shrink: true } }} fullWidth />
        </Grid>
        <Grid item xs={12} sm={6}>
          <Field.Text name="Nationality" label="Quốc tịch" slotProps={{ inputLabel: { shrink: true } }} fullWidth />
        </Grid>
        <Grid item xs={12} sm={6}>
          <Field.Text name="Nation" label="Dân tộc" slotProps={{ inputLabel: { shrink: true } }} fullWidth />
        </Grid>
        <Grid item xs={12} sm={6}>
